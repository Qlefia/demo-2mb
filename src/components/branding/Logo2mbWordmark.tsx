/**
 * 2MB wordmark — paths use currentColor (parent controls contrast on dark/light surfaces).
 * Original glyph fills were off-white; use className `text-[#FAFAFA]` or accent as needed.
 */
export function Logo2mbWordmark({
  className,
  'aria-label': ariaLabel = '2MB',
}: {
  className?: string
  'aria-label'?: string
}) {
